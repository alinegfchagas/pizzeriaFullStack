    ...
    constructor() {
        ...
        this.insertData = async () => {
            await BaseDatabase_1.BaseDatabase
                ...
                .insert(data_1.pizzasSeed);
            await BaseDatabase_1.BaseDatabase
                .connection(PizzaDatabase_1.PizzaDatabase.TABLE_INGREDIENTS)
                .insert(data_1.ingredientsSeed);
            await BaseDatabase_1.BaseDatabase
                .connection(PizzaDatabase_1.PizzaDatabase.TABLE_PIZZAS_INGREDIENTS)
                .insert(data_1.pizzasIngredientsSeed);
        };
    }
}
